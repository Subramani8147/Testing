    ...
    <div>
      <div className="stat-grid">
        <div className="stat-card">
          <div className="stat-value">{summary.openTickets}</div>
          <div className="stat-label">Open tickets</div>
        </div>
        <div className="stat-card red">
          <div className="stat-value">{summary.criticalTickets}</div>
          <div className="stat-label">Critical, unresolved</div>
        </div>
        <div className="stat-card teal">
          <div className="stat-value">{summary.resolvedThisWeek}</div>
          <div className="stat-label">Resolved this week</div>
        </div>
        <div className="stat-card blue">
          <div className="stat-value">{summary.totalSops}</div>
          <div className="stat-label">SOPs in library</div>
        </div>
        <div className="stat-card">
        ...
        <div className="stat-card red">
          <div className="stat-value">{summary.assetsInRepair}</div>
          <div className="stat-label">Assets in repair</div>
        </div>
      </div>
